...
#Order df_0 in increasing grade of H.S education (HS.Grad). Check the position of the NA’s in HS.Grad…can you get them on top?

df_0[order(df_0$HS.Grad, decreasing = FALSE), ]
df_0[order(df_0$HS.Grad, decreasing = FALSE, na.last = FALSE), ]
